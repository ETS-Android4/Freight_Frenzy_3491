...
public class Armstrong extends Robot {
    ...
    private Servo leftCollectServo; //continous rotational servo
    private Servo rightCollectServo;
...
//        motorR.setMinimumSpeed(0.1);
    ...
    public void collectServoLeftDown(){leftCollectServo.setPosition(-0.7);}
    public void collectServoRightDown(){rightCollectServo.setPosition(0.7);}

    public void collectServoLeftUp(){leftCollectServo.setPosition(0.7);}
    public void collectServoRightUp(){rightCollectServo.setPosition(-0.7);}

    public void collectServoRightStop() {rightCollectServo.setPosition(0);}
    public void collectServoLeftStop() {leftCollectServo.setPosition(0);}

    public void collectServoLeftSlow() {leftCollectServo.setPosition(0.05);}
    public void collectServoRightSlow() {rightCollectServo.setPosition(-0.05);}
